...
const ZOMBIEMAYEM = function () {
    ...
    const WAVE_1_ZOMBIE_QTY = getRandom(1,1),
    WAVE_2_ZOMBIE_QTY = getRandom(1,1),
    WAVE_3_ZOMBIE_QTY = getRandom(1,1),
    WAVE_4_ZOMBIE_QTY = getRandom(1,1),
    ...
    let zombieType = wave === 1 ? getRandom(4,6) : wave === 2 ? getRandom(1, 4) : getRandom(1, 6);
...
document.querySelector(".treat-btn").addEventListener("click", async () => {
