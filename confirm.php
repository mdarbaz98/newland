                            ...
                            <div class="order-product">
                                ...
                                <div class="row py-3 product-row" style=" justify-content: center; ">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <a class="product-title mb-2" style=" font-size: 12px; color: #000; "><?php echo $productName ?> (<?php echo $strengthName; ?>)</a>
                                ...
                                <div class="product-cart">
                                    <div class="product-heading" style=" font-size: 15px; font-weight: 700; ">BILLING DETAILS</div>
                                        ...
                                        <div class="price-cart-align">
                                            ...
                                            ?>
                                            <p><span style="color:#000;"><?php echo $_SESSION["currency_symbol"].number_format(($dcharge*$_SESSION["currency_rate"]),2); ?></span></p>
                                            <?php
                                                }
                                            ?>
                                        </div>
                                        <div class="price-cart-align">
                                            <p class="">Discount<?php
                                                ...
                                                ?></p>
                                            <p class="discount-rate"><?php echo $_SESSION["currency_symbol"].number_format(($discount*$_SESSION["currency_rate"]),2); ?></p>
                                        </div>
                                        <div class="price-cart-align">
