	...
	<tbody>
		...
		$msg .='</tr>
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=tramex&sts='.$row['status'].'&id='.$id.'" style="padding: 10px 20px;
...
sendmail("admin@buytramadolonlinecod.com", "Tramadol Export", $toemail, "Your Order Status | tramadolexport.com", $msg);
