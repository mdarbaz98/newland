	...
	<tbody>
		<tr>
			<td colspan="2" style="border-bottom:1px solid #d9d9d9;">
				...
				<ul style="float:right;margin: 8px;">
					...
					<li style="display:inline;font-size:14px;font-weight:700;"> admin@tramadolsale.com </li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		$msg .='</tr>
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=drugstore&sts='.$row['status'].'&id='.$id.'" style="padding: 10px 20px;
				...
				<tr>
					...
					<p><b>3 Things you have agreed on</b><br>
						<ol>
							...
							<hr>
							<li>Instead I will mention that i paid for Kids Toys as showed in my cart on checkout.</li>
							<hr>
...
sendmail("admin@buytramadolonlinecod.com", "Drugstore Planet", $toemail, "Your Order Status | drugstoreplanet.com", $msg);
