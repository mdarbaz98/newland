	...
	<tbody style="background: aliceblue;">
		...
		$msg .='</tr>
				...
				<tr>
					...
					<p style=" color: #fff; font-weight: 800; padding: 3px 30px; border-radius: 31px; font-size: 13px; "><b style=" font-size: 28px; ">1</b>. I will not mention anything about the purchase of medications (with Credit/debit Card Company or PayPal).</p>
					...
					<p style=" color: #fff; font-weight: 800; padding: 3px 30px; border-radius: 31px; font-size: 13px; "><b style=" font-size: 28px; ">3</b>. In case of issues related to my order, I agree to contact your Customer Support instead of making chargeback or dispute with Credit/debit Card Company or PayPal.</p>
					</p>
					</td>
				</tr>
...
sendmail("order@selcoenterprises.com", "Newlands Pharmacy", $toemail, "Your Order With One Newlands Pharmacy is delivered. | ONEGLOBALPHARMA.com", $msg);
