...
$sql3 = 'UPDATE `orders` SET `status`="Tracking" WHERE `id`="'.$id.'"';
...
// sendmail("admin@selcoenterprises.com", "Newlands Pharmacy", $to_email, "Tracking Number For Your Order Is Updated | Globalpharmameds.com", $str);
