	...
	<tbody>
		<tr>
			<td colspan="2" style="border-bottom:1px solid #d9d9d9;">
				...
				<ul style="float:right;margin: 8px;">
					...
					<li style="display:inline;font-size:14px;font-weight:700;"> admin@buytramadolonlinecod.com </li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		$msg .='</tr>
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=trolcd&sts='.$row['status'].'&id='.$id.'" style="padding: 10px 20px;
