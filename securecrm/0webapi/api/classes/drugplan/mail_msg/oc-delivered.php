	...
	<tbody>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<br>
				 ...
				 <a href="https://oneglobalpharma.com/intermediate/cust_del_complete.php?web=drugstore&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Yes, i received my order</a><br><br>
				 
				 <a href="https://oneglobalpharma.com/intermediate/cust_not_recv_order.php?web=drugstore&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">I have not received my order yet</a><br><br>
				 
				 <a href="https://oneglobalpharma.com/intermediate/miss_medication_recv.php?web=drugstore&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Received incomplete/incorrect/duplicate or expired medication</a>
				 <br>
				 <br>
			</td>
		</tr>
		...
		$msg .='</tr>
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=drugstore&sts=Delivered&id='.$id.'" style="padding: 10px 20px;
					...
					<br>
						<table width="100%" style="text-align:center;">
							<tr>
								...
								<td width="30%">
									<p>
									<a href="https://oneglobalpharma.com/intermediate/rep_an_issue.php?web=drugstore&id='.$id.'" style="	border:2px solid #0085eb;
														padding: 22px;
														color: #0085eb;
														font-size: 17px;
														text-decoration: none;
				...
				<tr>
					...
					<p><b>3 Things you have agreed on</b><br>
						<ol>
							...
							<hr>
							<li>Instead I will mention that i paid for Books as showed in my cart on checkout.</li>
							<hr>
...
sendmail("admin@buytramadolonlinecod.com", "Drugstore Planet", $toemail, "Your Order Delivered Successfully | drugstoreplanet.com", $msg);
