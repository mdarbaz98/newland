                 ...
                 <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;width: 20%;background: #0a9d7b;color: #fff;">
                            <p style="font-weight: 600;font-size: 14px;padding: 0 3px;">'.str_replace("-","",$data->invid).'</p>
                        </td>
                    </tr>
                 </tbody>
              </table>
                             ...
                             <tbody>
                                <tr>
                                   <td align="center" style="background-color:#ffffff;border:1px solid #0a9d7b;margin-top:52px;padding: 0 19px;" class="esd-block-text">
                                      ...
                                      <p style="text-align: left;">Thanks for shopping with Newlands Pharmacy. We have received your order on '.$data->date.'
                                      ...
                                      <p style="text-decoration:underline;text-align: center;font-weight: 600;">Note: Name on bank statement for your order of $'.$data->total.' will be Newlands Pharmacy. 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-block-text" align="center">
                                                        <p><strong>
                                                        <a href="https://oneglobalpharma.com/confirm/receive_order/'.str_replace("#","",$data->invid).'" style="border-radius:5px!important;font-weight:bold!important;padding: 4px 8px!important;text-decoration:none!important;border-width:10px 20px!important;color:#ffffff!important;background: #174ea6 !important;border-color: #008b00!important;display:block!important;width:fit-content!important;margin:11px auto!important">
                                                            Terms & Conditions
                                                        </a>
...
$subject = "Here is your invoice to pay for $".$data->total;
...
$post_data = [
        ...
        'method'=>'http', 
        'to'=>$data->phone, 
        'message'=>'Dear '.$data->name.', payment link of $'.$data->total.' for your invoice number '.str_replace("#","",$data->invid).' have generated. View Here: '.$payLinkShort.' and Pay here: '.$paypalLink.' - GlobalPharma', 
        'senderid'=>'mycompany'];
    $ch = curl_init(); 
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
  CURLOPT_CUSTOMREQUEST => "POST",
  CURLOPT_POSTFIELDS => "token=mp15jsuyuzvpfrhz&to=".$data->phone."&body=Dear ".$data->name.", payment link of $".$data->total." for your invoice number ".str_replace('#','',$data->invid)." have generated. View Here: ".$payLinkShort." and Pay Here ".$paypalLink." - GlobalPharma&priority=0&referenceId=",
  CURLOPT_HTTPHEADER => array(
    "content-type: application/x-www-form-urlencoded"
  ),
));
