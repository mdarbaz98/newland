...
<head>
	...
	<tbody style="background: aliceblue;"> 
		<tr>
			<td colspan="2" align="center">
				 ...
				 if($row['status']=="Processed"){
				     $mail_subject = 'Your invoice has been paid successfully | GLOBALPHARMA';
                         ...
                         <tbody>
                            <tr>
                                <td style="display:flex;width: 80%;">
                                    <img class="adapt-img" src="https://myglobal1.gumlet.io/images/newlandlogo.png" alt width="130" style="display: block;">
                                </td>
                                <td style="text-align: center;width: 20%;background: #0a9d7b;color: #fff;">
                                    <p style="font-weight: 600;font-size: 14px;">'.str_replace("-","",$invid).'</p>
                                </td>
                            </tr>
                         </tbody>
                      </table>
                                     ...
                                     <tbody>
                                        <tr>
                                           <td align="center" style="background-color:#ffffff;border:1px solid #0a9d7b;margin-top:52px;padding: 0 19px;" class="esd-block-text">
                                              ...
                                              placed on '.$date.'. We will update you with <b>Tracking Number</b> in 24 to 48 business hours.</p>
                ...
                <tr><td style="padding-bottom: 10px;"></td></tr>     
				    ';
				     ...
				     $mail_subject = 'Your Order has been Shipped successfully';
				     $post_data = [
                        'username'=>'Newlands Pharmacy', 
                        'key'=>'Newlands Pharmacy@2022', 
                        'method'=>'http', 
                ...
                <tr><td style="padding-bottom: 10px;"></td></tr>     
				 ';
				     ...
				     $mail_subject = 'Your Tracking Details has beed updated successfully | Newlands Pharmacy';
                                     ...
                                     <tbody>
                                        <tr>
                                           <td align="center" style="background-color:#ffffff;border:1px solid #0a9d7b;margin-top:52px;padding: 0 19px;" class="esd-block-text">
                                              ...
                                              <img src="https://gcdnb.pbrd.co/images/40QxtShUbh7J.png?o=1" style="width: 245px;">
                ...
                <tr><td style="padding-bottom: 10px;"></td></tr>  ';
				      ...
				      $mail_subject = 'Your Order with Newlands Pharmacy is Delivered';
				      $post_data = [
                        'username'=>'Newlands Pharmacy', 
                        'key'=>'Newlands Pharmacy@2022', 
                        'method'=>'http', 
                                     ...
                                     <tbody>
                                        <tr>
                                           <td align="center" style="background-color:#ffffff;border:1px solid #0a9d7b;margin-top:52px;padding: 0 19px;" class="esd-block-text">
                                              ...
                                              <img src="https://gcdnb.pbrd.co/images/mm2z7H2yNV8e.png?o=1" style="width: 245px;">
		...
		<td style="padding: 17px 20px 13px 20px;background: #fff;border: 1px solid #0a9d7b;">';
				...
				if($row['status']=="Processed"){
                	$msg .= '
                		<img src="https://myglobal1.gumlet.io/assets/preceed1.png" style="width:100%; margin: 0 auto;">
                	';
                	} else if($row['status']=="Shipped") {
                	$msg .= '
                		<img src="https://myglobal1.gumlet.io/assets/shipped1.png" style="width:100%; margin: 0 auto;">
                	';
                	}
                	else if($row['status']=="Tracking") {
                	$msg .= '
                		<img src="https://myglobal1.gumlet.io/assets/tracking1.png" style="width:100%; margin: 0 auto;">
                	';
                	}
                	else{
                	$msg .= '
                		<img src="https://myglobal1.gumlet.io/assets/delivered1.png" style="width:100%; margin: 0 auto;">
                	';
                }
				...
				<tr>
                    <td class="esd-structure es-p20t es-p20r es-p20l" align="left" bgcolor="#010101"
                        style="background-color: #ffffff;border: 1px solid #0e810e; padding: 25px 0;" esd-custom-block-id="481465">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-block-text" align="center">
                                                        <p><strong>
                                                        <a href="https://oneglobalpharma.com/confirm/receive_order/'.str_replace("#","",$invid).'" style="border-radius:5px!important;font-weight:bold!important;padding: 4px 8px!important;text-decoration:none!important;border-width:10px 20px!important;color:#ffffff!important;background: #174ea6 !important;border-color: #008b00!important;display:block!important;width:fit-content!important;margin:11px auto!important">
                                                            Terms & Conditions
                                                        </a>
                                                ...
                                                <tr style="padding: 5px 20px;">
                                                    <td align="center" class="esd-block-text es-p20t es-p20b"
                                                        ...
                                                        <p style="line-height: 1;color: #000; margin: 0;"><b>24/7 Assistance</b></p>
                                                        <br>
                                                        <p style="line-height: 1;color: #000; margin: 0;">
                                                        Call
                                                                <a target="_blank"
                                                                href="tel:13155154364" style="text-decoration: none;">+1
                                                                315 515 4364</a> Email  
                                                                <a target="_blank"
                                                                href="mailto:admin@oneglobalpharma.com"
                                                                style="line-height: 120%; text-decoration: none;">admin@oneglobalpharma.com</a>
                                                                or <a target="_blank" href="https://newlandspharma.co.uk/"
                                                ...
                                                <tr>
                                                    <td align="center" class="esd-block-text es-p20t es-p20b"
                                                        esd-links-underline="none">
                                                        <p style="line-height: 1;color: #000; margin: 0;"><b>Our Guarantee</b></p>
                                                        <br>
                                                        <p style="line-height: 1;color: #000; margin: 0;">
                                                            Your satisfaction is 100% guaranteed.<br>
                                                            See our <a
                                                            target="_blank"
