	...
	<tbody>
		<tr>
			<td colspan="2" align="center">
				<img src="https://bit.ly/38pPmet" width="200px">
				<br>
				<br>
			</td>
		</tr>
				...
				<h3>Thank You For Shop with us</h3>';
				    ...
				    if($nor>0 && $nor < 2) {
						...
						$str .= '<h1>Your Traking ID: '.$row->tracking_id.'</h1>
						 ...
						 <p style="text-align:center;color:#a9a9a9;">We are contacting you from Buytramadolonlinecod Thank you very much for providing an opportunity to do business with you.</p>
						 <br>
						 <br>';
...
sendmail("admin@buytramadolonlinecod.com", "Buy Tramadol Online", $to_email, "Track Your Order", $str);
