...
class ClientTest extends TestCase
{
    ...
    {
        $this->host = 'https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010';
        $this->headers = [
    ...
    public function test__call()
    {
        ...
        $this->assertAttributeEquals('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010/v3/', 'url', $client);

        $queryParams = ['limit' => 100, 'offset' => 0];
        $client = $this->client->get(null, $queryParams);
        $this->assertAttributeEquals('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010/v3/?limit=100&offset=0', 'url', $client);
    ...
    {
        $client = new Client('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010');
        $this->assertSame('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010', $client->getHost());
    }

    public function testGetHeaders()
    {
        $client = new Client(
            'https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010',
        ...
        $client2 = new Client('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010');
        $this->assertSame([], $client2->getHeaders());
    }

    public function testGetVersion()
    {
        $client = new Client('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010', [], '/v3');
    ...
    {
        $client = new Client('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010', [], null, ['/foo/bar']);
    ...
    {
        $client = new Client('https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010', ['User-Agent: Custom-Client 1.0']);
    ...
    public function testFormRepeatUrlArgs()
    {
        ...
        $this->assertEquals($result, 'https://newlandspharma.c7h06yjxgkol.us-east-2.rds.amazonaws.com:4010/?thing=stuff&foo=bar&foo=bat&foo=baz');
    }
