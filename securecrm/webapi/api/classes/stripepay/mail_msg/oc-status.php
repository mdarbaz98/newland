		...
		<tr>
			<td colspan="2" align="center">
				...
				<br><br>
				 ...
				 <h2 style="background-color: #bcd0f6;padding: 10px; width: fit-content;border-radius: 25px;border: 2px solid #80abff;">ORDER ID: '.$orderid.'</h2>
		...
		<tr>
			...
			<table align="center" width="100%;" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=stripepay&sts='.$row['status'].'&id='.$id.'" style="padding: 10px 20px;
...
sendmail("admin@selcoenterprises.com", $row['web'], $toemail, "Your Order Status | ".$row['web'], $msg);
?>