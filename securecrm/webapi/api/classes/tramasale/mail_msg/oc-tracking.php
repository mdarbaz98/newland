	...
	<tbody>
		<tr>
			<td colspan="2" align="center">
				<img src="https://tramadolsale.com/wp-content/uploads/2019/03/Tramadolsale-logo-dark-300x131.png" width="200px">
				<br>
				<br>
			</td>
		</tr>
				...
				<h3>Thank You For Shop with us</h3>';
				    ...
				    if($nor>0 && $nor < 2) {
						...
						$str .= '<h1>Your Traking ID: '.$row->tracking_id.'</h1>
						 ...
						 <p style="text-align:center;color:#a9a9a9;">We are contacting you from tramadolsale.com Thank you very much for providing an opportunity to do business with you.</p>
						 <br>
						 <br>';
...
sendmail("admin@tramadolsale.com", "Tramadol Sale", $to_email, "Track Your Order | tramadolsale.com", $str);
