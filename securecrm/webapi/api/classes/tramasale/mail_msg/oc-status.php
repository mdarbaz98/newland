	...
	<tbody>
		...
		$msg .='</tr>
				...
				<tr>
					...
					<br><br>
						<a href="https://oneglobalpharma.com/intermediate/oc_sts_report.php?web=tramsale&sts='.$row['status'].'&id='.$id.'" style="padding: 10px 20px;
...
sendmail("admin@tramadolsale.com", "Tramadol Sale", $toemail, "Your Order Status | tramadolsale.com", $msg);
