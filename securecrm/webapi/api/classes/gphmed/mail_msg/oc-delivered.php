	...
	<tbody>
		<tr>
			<td colspan="2" align="center">
				...
				<br>
				 <h3 style="color: #009b00;">Your Order Has Been Delivered .</h3>
				 <p>What\'s next? Please confirm that you received order from below options</p>
				 <h4 style="background-color: #bcd0f6;padding: 5px; width: fit-content;border-radius: 25px;border: 2px solid #bcbcbc;color:#808080;">ORDER ID: '.$invid.'</h4>
				 
				 
				 <a href="https://oneglobalpharma.com/intermediate/cust_del_complete.php?web=globpharmedz&id='.$id.'" style="background-color: #4c89ff;padding: 5px 10px;border: 2px solid #4c89ff;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Yes, i received my order</a><br><br>
				 
				 <a href="https://oneglobalpharma.com/intermediate/cust_not_recv_order.php?web=globpharmedz&id='.$id.'" style="display: inline; background-color: #4c89ff;padding: 5px 10px;border: 2px solid #4c89ff;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">I have not received my order yet</a><br><br>
				 
				 <a href="https://oneglobalpharma.com/intermediate/miss_medication_recv.php?web=globpharmedz&id='.$id.'" style="display: inline; background-color: #4c89ff;padding: 5px 10px;border: 2px solid #4c89ff;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Received incomplete/incorrect order</a>
				 <br>
				 <br>
			</td>
		</tr>
					...
					<br>
						<table width="100%" style="text-align:center;">
							<tr>
								...
								<td width="30%">
									<p>
									<a href="https://oneglobalpharma.com/intermediate/rep_an_issue.php?web=globpharmedz&id='.$id.'" style="	border:2px solid #0085eb;
														padding: 22px;
														color: #0085eb;
														font-size: 17px;
														text-decoration: none;
...
sendmail("admin@globalpharmameds.com", "Newlands Pharmacy", $toemail, "Your Order Has Been Delivered | Globalpharmameds.com", $msg);
