			...
			<td colspan="2" align="center">
				<img src="https://memegene.net/sites/default/files/wallpaper/green-tick-clipart/281623/green-tick-clipart-transparent-background-281623-7199576.png" width="80px;" style="margin: 0px auto;">
				 <h2>Thank You For Your Order!</h2>
				  <p style="text-align:center; color: #f31d1d;font-size: 15px;">we are Contacting from Selco Enterprises Pvt Ltd <br> Invoice sent from mkdmarine@gmail.com on your email <br>Sender name : mustafa teli </p>
				 <br>
			</td>
		</tr>
		<tr>
			...
			<table align="center" width="100%;" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td style="padding-top: 0px;" colspan="2" align="left">
						...
						<p>We have sent you an invoice through paypal for <b style="color: #d48344">$'.$row['ptot'].'</b> on the given email address</p>

						<p>you can go ahead and make an online payment directly from your end using credit/Debit card if you dont have paypal</p>
						...
						<p>If you receive a call from paypal or from credit card company asking about the nature of the payment, just mention that you ordered Household goods from us,</p>

						<p>your products will be shipped by india post and Shipping time is 12-15 days (Trackable service)</p>

						<p>If you agree on all above mention details, please pay me <b style="color: #d48344">$'.$row['ptot'].'</b> on invoice from mkdmarine@gmail.com (mustafa teli)</p>
