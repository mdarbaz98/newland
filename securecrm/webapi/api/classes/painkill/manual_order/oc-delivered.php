		...
		<tr>
			<td colspan="2" align="center">
				...
				<br>
				 ...
				 <a href="http://selcoenterprises.com/intermediate/cust_del_complete.php?web=manualoc&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Yes, i received my order</a><br><br>
				 
				 <a href="http://selcoenterprises.com/intermediate/cust_not_recv_order.php?web=manualoc&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">I have not received my order yet</a><br><br>
				 
				 <a href="http://selcoenterprises.com/intermediate/miss_medication_recv.php?web=manualoc&id='.$id.'" style="background-color: #63ffdb;padding: 5px 10px;border: 2px solid #00e3d9;border-radius: 25px;font-weight:600;color:#000;text-decoration:none;">Received incomplete/incorrect/duplicate or expired medication</a>
				 <br>
				 <br>
			</td>
		</tr>
