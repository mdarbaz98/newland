<?php 
    ...
    $ingredientName = ucwords(str_replace('-', ' ',$_GET['brandName']));
    $per_page=12;
    $start=0;
    $current_page=1;
    if(isset($_GET['page'])){
...
<main class="shop-page offcanvas-enabled" style="padding-top: 89px; background: rgba(0,0,0,0);">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 shop-products col-12 p-4" style="">
                <section class="">
                    <!--<?php echo $productSlugNew; ?>-->
                        <div class="row mx-n2">
                            <h3 class="text-center"><?php echo $ingredientName; ?></h3>
                            <?php
                            ...
                            $select_product=$conn->prepare("SELECT * FROM ogproduct INNER JOIN ogproductaltname ON ogproduct.productCode=ogproductaltname.productCode WHERE ogproductaltname.productAltName LIKE '%".$ingredientName."%'");
                            $select_product->execute();  
